...
launch a simple one and point your default browser to [`http://localhost:8000/presentation-output.html`](http://localhost:8000/presentation-output.html):
...
To enable presenter mode, add `presentme=true` to the URL: [http://localhost:8000/presentation-output.html?presentme=true](http://localhost:8000/presentation-output.html?presentme=true)

To disable presenter mode, hit [http://localhost:8000/presentation-output.html?presentme=false](http://localhost:8000/presentation-output.html?presentme=false)
