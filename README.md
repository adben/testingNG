...
launch a simple one and point your default browser to [`http://localhost:8000/workflowangularjs.html`](http://localhost:8000/workflowangularjs.html):
...
To enable presenter mode, add `presentme=true` to the URL: [http://localhost:8000/workflowangularjs.html?presentme=true](http://localhost:8000/workflowangularjs.html?presentme=true)

To disable presenter mode, hit [http://localhost:8000/workflowangularjs.html?presentme=false](http://localhost:8000/workflowangularjs.html?presentme=false)
